...
#define THREAD_BLOCK_1D_SIZE 1024
#define THREAD_BLOCK_2D_SIZE 32 
...
void compute_native(const matrix_t, matrix_t, const matrix_t);
void compute_optimized(const matrix_t, matrix_t, const matrix_t);
